...
| Email providers     | `EmailProvider` protocol with typed auth, metadata, cursor, candidate-query, and retained-body DTOs; exported Gmail skeleton present, runtime behavior deferred |
