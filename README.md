...
- Current retained body fetching: Gmail can fetch normalized retained bodies for selected refs behind the provider seam; callback handling, token exchange, token persistence, endpoint-driven message sync, and repository writes for retained bodies remain later Phase 1 work.
