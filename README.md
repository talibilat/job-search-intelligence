...
[JT-103 2026-07-05 v1] Backend role normalization test: `uv run pytest tests/test_role_normalization.py -v` verifies casing, punctuation, seniority labels, title levels, abbreviations, location noise, work-arrangement notes, and missing titles.
