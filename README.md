...
The persistent backend database engine is not scaffolded yet; the synthetic fixture loader can still populate caller-provided local SQLite connections for deterministic backend tests.
