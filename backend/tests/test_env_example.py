...
EXPECTED_ENV_KEYS = {
    ...
    "JOBTRACKER_API_HOST",
    "JOBTRACKER_API_PORT",
    "JOBTRACKER_API_PUBLIC_URL",
    "JOBTRACKER_CORS_ORIGINS",
    "JOBTRACKER_FRONTEND_URL",
    ...
    "JOBTRACKER_WEB_SEARCH_PROVIDER",
    "JOBTRACKER_WEB_SEARCH_ENABLED",
    ...
    "JOBTRACKER_CLASSIFICATION_CONCURRENCY",
    "JOBTRACKER_PROCESSING_MAX_CANDIDATES_PER_RUN",
    ...
    "JOBTRACKER_INSIGHT_ESTIMATE_CHARS_PER_UNIT",
    "JOBTRACKER_INSIGHT_INPUT_COST_PER_1K_UNITS_USD",
    "JOBTRACKER_INSIGHT_OUTPUT_COST_PER_1K_UNITS_USD",
    "JOBTRACKER_CHAT_INDEX_MAX_EMAILS",
    "JOBTRACKER_CHAT_MAX_VECTOR_DISTANCE",
    "JOBTRACKER_LLM_TIMEOUT_SECONDS",
    "JOBTRACKER_LLM_MAX_RETRIES",
    "JOBTRACKER_TAVILY_BASE_URL",
    "JOBTRACKER_WEB_SEARCH_MAX_RESULTS",
    "JOBTRACKER_WEB_SEARCH_TIMEOUT_SECONDS",
    ...
    "JOBTRACKER_FOLLOW_UP_THRESHOLD_DAYS",
}
