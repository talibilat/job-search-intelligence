...
Insights service + page (why-rejected, skill-gaps, strongest/weakest signals, role-fit, weekly actions, story); cached with `regenerate`, stale detection, and user-triggered regeneration.
