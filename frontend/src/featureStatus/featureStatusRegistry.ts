...
export const featureStatusRegistry: readonly FeatureStatusRecord[] = [
  ...
  },
  {
    ...
    blockers: [],
    components: ["ChatDrawer", "EmailReaderDialog"],
    connectedModules: [
      "Grounded chat API",
      "Hybrid RAG agent",
    ...
    howToUse: {
      ...
      prerequisites: ["Configured chat and embedding provider", "Processed application data"],
      qaValidationPoints: [
        "Quantitative answers reconcile with deterministic dashboard metrics.",
        "Content answers cite a real application or public-safe email reference.",
        "History reloads from local SQLite after refresh.",
        "Provider errors and unsupported questions never fabricate an answer.",
      ],
      steps: [
        "Open /chat or press Ask AI.",
        "Ask how many applications exist and compare the answer with Overview.",
        "Ask what a recruiter said and open the cited evidence.",
        "Refresh and confirm the persisted conversation returns.",
      ],
    },
    id: "frontend-chat-ui",
    implementationStatus:
    ...
    testing: {
      canTestNow: true,
      entryPoint: "/chat",
      exampleInputs: ["How many applications have I submitted?", "What exactly did the recruiter say?"],
      expectedOutputs: [
        "Progressive route, tool, and answer states",
        "Dashboard-consistent quantitative answer",
        "Navigable application or email citation",
      ],
      requiredSetup: ["Frontend and backend", "Configured LLM provider", "Processed fixture data"],
    },
  },
  {
    area: "frontend",
