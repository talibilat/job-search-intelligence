...
export const featureStatusRegistry: readonly FeatureStatusRecord[] = [
  ...
  },
  {
    ...
    description:
      "Deterministic dashboard route with summary metric cards, Q-11 response-rate, Q-16 funnel, and placeholders for remaining dashboard metrics.",
    ...
    howToUse: {
      ...
      qaValidationPoints: [
        ...
        "Q-16 full funnel shows deterministic applied, screen, interview, final, and offer counts.",
      ...
      steps: [
        ...
        "Confirm the Q-16 funnel loads from GET /metrics/funnel.",
